...
8. 高频操作可直接使用已设置的快捷键；也可从菜单栏子菜单选择任意模板快速处理。
9. 需要更换快捷键时，在右侧“快捷操作”点击录制框并按下新组合键。

详细说明见 [安装文档](docs/INSTALL.md)、[v0.3.2 PRD](docs/prd/v0.3.2/prd.md) 和 [v0.3.2 测试报告](docs/testing/v0.3.2-test-report.md)。
